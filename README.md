...
Before logfile tools process a node, the database is resolved using the CLI resolver. Nested recipe references are expanded with quantity multiplication; elements missing from the database remain unchanged.
